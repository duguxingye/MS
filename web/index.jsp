    ...
    <head>
        <nav class="blue lighten-1" role="navigation">
            <div class="nav-wrapper container">
                <a id="logo-container" href="index.jsp" class="brand-logo white-text">泰允升科技</a>

                <ul class="right hide-on-med-and-down">
                    <li class="active"><a href="index.jsp" class="white-text">首页</a></li>
                    ...
                    <li><a href="<c:url value='/login' />" class="waves-effect waves-light btn blue lighten-1" style="border-radius:1.5em;">登录</a></li>
                </ul>
                        ...
                        <ul class="collapsible collapsible-accordion">
                            <li>
                                ...
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="/static/page-tech/tech_serv.html">技术服务</a></li>
                                        <li><a href="/static/page-car/car_serv.html">汽车服务</a></li>
                                        <li><a href="/static/page-mesg/mesg_serv.html">信息服务</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li><a href="index.jsp#about_us">关于我们</a></li>
                            <li><a href="index.jsp#connect_us">联系我们</a></li>
                ...
                <div id="serv" class="row">
                    <div class="col s12 m4">
                        <div class="icon-block">
                            ...
                            <div class="row center">
                                <a href="/static/page-tech/tech_serv.html" class="btn waves-effect waves-light blue lighten-1">了解更多</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col s12 m4">
                        <div class="icon-block">
                            ...
                            <div class="row center">
                                <a href="/static/page-car/car_serv.html" class="btn waves-effect waves-light blue lighten-1">了解更多</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col s12 m4">
                        <div class="icon-block">
                            ...
                            <div class="row center">
                                <a href="/static/page-mesg/mesg_serv.html" class="btn waves-effect waves-light blue lighten-1">了解更多</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="section">
                <div class="row" style="background: #ececec;">
                    <div id="about_us" class="col l6 s12">
                        ...
                        <blockquote>
                            公司业务主要有三大模块 <br>
                            <strong>1.技术服务</strong> <br>
                            <strong>2.汽车服务</strong> <br>
                            <strong>3.信息服务</strong> <br>
                        </blockquote>
                    ...
                    <div class="col l6 s12 center">
                        <img class="responsive-img" src="/static//image/index/tech.png">
                    </div>
                </div>
            </div>

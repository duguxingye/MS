                        ...
                        <table class="bordered">
                            ...
                            <c:forEach items="${productInsList}" var="productIns" varStatus="status">
                                <tr>
                                    ...
                                    <sec:authorize access="hasRole('ADMIN')">
                                        <td>
                                            <a href="<c:url value='/edit-product-person-${productIns.id}' />" class="waves-effect waves-light btn">修改</a>
                                        </td>
                                        <td>
                                            <a href="#person${productIns.id}" class="waves-effect waves-light btn modal-trigger">删除</a>
                                            <div id="person${productIns.id}" class="modal">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="<c:url value='/delete-product-person-${productIns.id}' />" class=" modal-action modal-close waves-effect waves-green btn">确认</a>
                                                </div>
                                            </div>
                                        </td>
                                    </sec:authorize>
            ...
            <sec:authorize access="hasRole('AREA') or hasRole('GROUP') or hasRole('REGULAR')">
                <div style="position: relative; height: 70px;">
                    <div class="fixed-action-btn horizontal click-to-toggle">
                        ...
                        <ul>
                            <li><a class="btn-floating tooltipped green" href="<c:url value='/upload-product-person' />" data-position="top" data-delay="50" data-tooltip="导入Excel"><i class="material-icons">unarchive</i></a></li>
                            <li><a class="btn-floating tooltipped red" href="<c:url value='/add-product-person' />" data-position="top" data-delay="50" data-tooltip="添加"><i class="material-icons">add</i></a></li>
            ...
            <sec:authorize access="hasRole('ADMIN')">
                <div style="position: relative; height: 70px;">
                    <div class="fixed-action-btn">
                        <a class="btn-floating btn-large red" href="<c:url value='/export-product-person' />">

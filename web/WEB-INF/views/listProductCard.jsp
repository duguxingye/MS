                            ...
                            <c:forEach items="${productInsList}" var="productIns" varStatus="status">
                                <tr>
                                    ...
                                    <sec:authorize access="hasRole('ADMIN')">
                                        ...
                                        <td>
                                            <a href="#card${productIns.id}" class="waves-effect waves-light btn modal-trigger">删除</a>
                                            <div id="card${productIns.id}" class="modal">
            ...
            <sec:authorize access="hasRole('AREA') or hasRole('GROUP') or hasRole('REGULAR')">
                <div style="position: relative; height: 70px;">
                    <div class="fixed-action-btn horizontal click-to-toggle">
                        ...
                        <ul>
                            <li><a class="btn-floating tooltipped green" href="<c:url value='/upload-product-card' />" data-position="top" data-delay="50" data-tooltip="导入Excel"><i class="material-icons">unarchive</i></a></li>
                            <li><a class="btn-floating tooltipped red" href="<c:url value='/add-product-card' />" data-position="top" data-delay="50" data-tooltip="添加"><i class="material-icons">add</i></a></li>
                            <li><a class="btn-floating tooltipped blue" href="<c:url value='/export-product-card' />" data-position="top" data-delay="50" data-tooltip="导出为Excel"><i class="material-icons">archive</i></a></li>
                        </ul>
                    </div>
                </div>
            </sec:authorize>
            ...
            <sec:authorize access="hasRole('ADMIN')">
                <div style="position: relative; height: 70px;">
                    <div class="fixed-action-btn">
                        <a class="btn-floating btn-large red" href="<c:url value='/export-product-card' />">
